...
建議從 GitHub Release 依照硬體下載對應的 v1.3.1 完整包，合併分割檔後解壓執行：
...
| SHA256 | `SHA256SUMS-v1.3.1.txt` | 驗證下載與合併後檔案完整性 |
...
也可以使用 7-Zip 或其他支援分割檔的工具，從 `.part01` 開始合併/解壓。合併後請依照 `SHA256SUMS-v1.3.1.txt` 驗證檔案完整性。
