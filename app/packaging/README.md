...
.\build_all_profiles.ps1 -Version 1.4.5 -Mode Final -ReuseRuntimeCache -CompressionLevel 7 -SplitSizeMiB 1900
```
...
```powershell
.\build_all_profiles.ps1 -Version 1.4.5 -Mode Quick -ReuseRuntimeCache -ReuseProfileArtifacts
```
...
```powershell
.\build_all_profiles.ps1 -Version 1.4.5 -Mode Final
```
